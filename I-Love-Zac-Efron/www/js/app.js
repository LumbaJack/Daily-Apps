        ...
        case 'registered':
            if ( e.regid.length > 0 ) {
                    ...
                    if(oldregid === null || oldregid != e.regid ) {
                          ...
                          jQuery.post( "http://hashmessenger.com/api-ugly/push_reg.php", { user: device.uuid , id: e.regid, app: "zacefron"}, function() { window.localStorage.setItem('pushreg', e.regid); });
                    }
            }
            break;
        case 'message':
